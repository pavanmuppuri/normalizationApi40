		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Normalisation",
									"targetURL": "#normalizePMRatingFormAPI40normalisationapi40-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"normalizePMRatingFormAPI40normalisationapi40-display": {
								"semanticObject": "normalizePMRatingFormAPI40normalisationapi40",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=normalizePMRatingFormAPI40.normalisationapi40",
									"url": sap.ui.require.toUrl("normalizePMRatingFormAPI40/normalisationapi40")
								}
							}
						}
					}
